            ...
            dispatch_async(dispatch_get_main_queue(), ^(void) {
                ...
                if (isSuccess) {
                    ...
                    if ([responseObject count] > 0) {
                        ...
                        NSString *path = [TAFileManager returnSpaceFolderPath:[responseObject[0][kMapId] description]];
                        
                        NSMutableDictionary *userMapDict = [NSMutableDictionary dictionaryWithDictionary:responseObject[0]];
                        
                        [userMapDict writeToFile:[NSString stringWithFormat:@"%@/%@map.plist",path,[responseObject[0][kMapId] description]] atomically:YES];
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.titleLabel.text = [MapAllDataArray[indexPath.row][kBuildName] description];
